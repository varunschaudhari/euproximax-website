...
import { ArrowRight, Lightbulb, Box, Users, Factory, Wrench, FileText, Boxes, Layers, Package } from 'lucide-react'
  ...
  const services = [
    {
      ...
      description: 'Brainstorming, mood boards, and sketching.',
    },
    {
      icon: Box,
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-text mb-6">
              Industrial Design <br />& Product Design
            </h1>
            <h2 className="text-2xl md:text-3xl font-semibold text-primary mb-6">
              Design That Inspires & Performs
            </h2>
            <p className="text-lg md:text-xl text-gray-600 mb-10 leading-relaxed max-w-3xl mx-auto">
              We transform your vision into a product that is both beautiful and functional.
              From concept sketches to production-ready designs, we ensure every detail enhances
              user experience and market appeal.
            </p>
            <Link
              to="/consultation"
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-xl mb-8 text-secondary-100 leading-relaxed">
              Contact our design experts to discuss your product design needs and bring your ideas to life.
            </p>
            <Link
              to="/contact"
